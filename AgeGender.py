...
faceProto = "./model_files/opencv_face_detector.pbtxt"
faceModel = "./model_files/opencv_face_detector_uint8.pb"

ageProto = "./model_files/age_deploy.prototxt"
ageModel = "./model_files/age_net.caffemodel"

genderProto = "./model_files/gender_deploy.prototxt"
genderModel = "./model_files/gender_net.caffemodel"
...
while cv.waitKey(1) < 0:
    ...
    for bbox in bboxes:
        ...
        cv.imwrite(f"./output/sample_output_{frame_count}.jpg",frameFace)
